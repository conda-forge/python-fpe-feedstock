...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-fpe-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14228&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-fpe-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-fpe` can be installed with:

```
conda install python-fpe
```

It is possible to list all of the versions of `python-fpe` available on your platform with:
